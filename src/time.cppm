...
namespace mars {
    export class Time {
        ...
        /// Returns:     The time between the last frame and the current frame, in the system's resolution time
        std::chrono::steady_clock::time_point::duration::rep deltaSystem() const noexcept;
        /// Gets the time between the last frame and the current frame. Make sure to call `updateTime` before any calls to this within the current frame.
